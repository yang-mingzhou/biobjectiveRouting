...
gcc -O3 -g -fsanitize=address -std=c99 -o bhepvPrecomputation.o bhepvPrecomputation.cpp bhepv.cpp bodPathRetrieval.c heap.c bod.c graph.c -lstdc++
gcc -O3 -g -fsanitize=address -std=c99 -o  bhepvPathRetrieval.o bhepvPathRetrieval.cpp hborWithBhepv.cpp pathRetrieval.c heap.c boastar.c graph.c -lstdc++
